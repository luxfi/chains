...
var (
	...
	// ErrOperatorBonded is the converse: the operator has not deregistered,
	// so no cooldown has started and there is no stake to withdraw.
	ErrOperatorBonded = errors.New("aivm/quorum: operator is still bonded")
