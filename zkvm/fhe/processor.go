...
type Processor struct {
	...
	secretKey *rlwe.SecretKey // Only for keygen - shares distributed to M-Chain (MPC) per LP-1340
...
// These shares should be distributed to M-Chain signers (per LP-1340; legacy: T-Chain)
