...
type Manifest struct {
	...
	// forbidden-reference deny-scan (so the Liquidity-universe check has labels to
...
// node startup gate to run the Liquidity-universe / forbidden-reference scan with the
