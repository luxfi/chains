...
// (Liquid EVM / Liquid DEX white-label) universe — or the upstream "partner" lineage —
...
// partner), or whose symbol/name names mock/synthetic liquidity, or whose symbol is an
