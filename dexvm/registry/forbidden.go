...
// canonical case is UniverseChainId.Liquidity* — the Liquidity white-label brand,
...
var forbiddenChainTokens = []string{
	"liquidity", // UniverseChainId.Liquidity* and any Liquidity-branded reference
	"liquid evm",
	"liquid dex",
}
...
// (white-label / off-network) universe such as Liquidity. Case-insensitive.
